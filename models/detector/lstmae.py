...
class Encoder(nn.Module):
    def __init__(self, input_size, hidden_size, dropout, latent_size, seq_len):
    ...
    def forward(self, x):
        ...
        latent = self.latent(x_enc)
        return latent, out


# Decoder Class
class Decoder(nn.Module):
    def __init__(self, input_size, hidden_size, dropout, latent_size, seq_len, use_act):
...
class LSTMAE(nn.Module):
    def __init__(self, input_size, hidden_size, dropout_ratio, latent_size, seq_len, use_act=True):
        ...
        self.encoder = Encoder(input_size=input_size, hidden_size=hidden_size, dropout=dropout_ratio, latent_size=latent_size, seq_len=seq_len)
        self.decoder = Decoder(input_size=input_size, hidden_size=hidden_size, dropout=dropout_ratio, latent_size=latent_size, seq_len=seq_len, use_act=use_act)
